...
namespace CRAD_DataBase
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-3FL948M;Initial Catalog=Test;Integrated Security=True;TrustServerCertificate=True");
        public Form1()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                using (SqlCommand checkCmd = new SqlCommand(checkQuery, conn))
                {
                    ...
                    else
                    {
                        ...
                        string insertQuery = "INSERT INTO Employee (ID, Name, Age, Salary, Gender) VALUES (@ID, @Name, @Age, @Salary, @Gender)";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = "UPDATE Employee SET Name = @Name, Age = @Age, Salary = @Salary, Gender = @Gender WHERE ID = @ID";
